...
const Footer = () => {
  ...
  return (
    <footer className="bg-white/80 dark:bg-black/80 backdrop-blur-md text-gray-900 dark:text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-2">Rajshahi, Bangladesh</p>
            <p className="text-gray-600 dark:text-gray-400">emamulmursalin.ice@gmail.com</p>
          </div>
        </div>
